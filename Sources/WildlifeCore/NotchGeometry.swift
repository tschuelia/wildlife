...
public struct NotchGeometry: Equatable, Sendable {
    ...
    public var leftWingWidth: CGFloat { notchFrame.minX - compactFrame.minX }
    public var rightWingWidth: CGFloat { compactFrame.maxX - notchFrame.maxX }
    ...
    public func expandedFrame(width requestedWidth: CGFloat, height requestedHeight: CGFloat) -> CGRect {
